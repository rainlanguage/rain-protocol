import { FlowERC1155IOStruct, FlowTransferStruct } from "../../typechain/contracts/flow/erc1155/FlowERC1155";
 ...
 * @param address address to fill in FlowTransferStruct
 */
 export const fillEmptyAddressERC20 = (flow: FlowERC20IOStruct, address: string): FlowERC20IOStruct => {
 ...
 * @param address address to fill in FlowTransferStruct
 */
 export const fillEmptyAddressERC721 = (flow: FlowERC721IOStruct, address: string): FlowERC721IOStruct => {
 ...
 * @param address address to fill in FlowTransferStruct
 */
 export const fillEmptyAddressERC1155 = (flow: FlowERC1155IOStruct, address: string): FlowERC1155IOStruct => {
