...
import "./SaleMutableAddressesTest.sol";

import "@openzeppelin/contracts/proxy/Clones.sol";

/// @title SaleMutableAddressesTestFactory
/// @notice Factory for creating and deploying
/// `SaleMutableAddressesTest` contracts.
contract SaleMutableAddressesTestFactory is Factory {
    ...
    constructor(SaleConstructorConfig memory config_) {
        address implementation_ =
            address(new SaleMutableAddressesTest(config_));
        // silence slither.
        ...
        returns (address)
    {
        ...
        SaleMutableAddressesTest(clone_)
    ...
    ) external returns (SaleMutableAddressesTest) {
        return
            SaleMutableAddressesTest(
                this.createChild(
