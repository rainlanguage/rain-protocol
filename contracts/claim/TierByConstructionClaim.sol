...
contract TierByConstructionClaim is TierByConstruction {
     ...
     */
    constructor(ITier _tierContract, ITier.Tier _minimumTier)
        public
        TierByConstruction(_tierContract)
    {
     ...
     */
    function claim(address _account, bytes memory _data)
        external
        onlyTier(_account, minimumTier)
    {
