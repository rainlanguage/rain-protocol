...
library TierOps {
    ...
    // to check against.
    function report(uint, uint256 stackTopLocation_) internal view returns (uint256) {
        uint256 location_;
        uint256 tier_;
        uint256 account_;
        assembly {
    ...
    function saturatingDiff(uint, uint256 stackTopLocation_)
        internal
        pure
        returns (uint256)
    {
    ...
    function selectLte(uint operand_, uint256 stackTopLocation_)
        internal
        pure
        returns (uint256)
    {
