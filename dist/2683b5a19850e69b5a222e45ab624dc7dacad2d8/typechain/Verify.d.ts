...
interface VerifyInterface extends ethers.utils.Interface {
  functions: {
    ...
    "states(uint256)": FunctionFragment;
  };
  ...
  encodeFunctionData(functionFragment: "ids", values: [string]): string;
...
export class Verify extends Contract {
  ...
  functions: {
    ...
    ban(id_: BigNumberish, overrides?: Overrides): Promise<ContractTransaction>;
    ...
    ids(arg0: string, overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    state(
      account_: string,
      overrides?: CallOverrides
    ): Promise<[[number, number] & { status: number; since: number }]>;
  ...
  "ids(address)"(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  callStatic: {
    ...
    approve(id_: BigNumberish, overrides?: CallOverrides): Promise<void>;
    ...
    ban(id_: BigNumberish, overrides?: CallOverrides): Promise<void>;

    "ban(uint256)"(id_: BigNumberish, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    Approve(id: BigNumberish | null): EventFilter;
  ...
  estimateGas: {
    ...
    approve(id_: BigNumberish, overrides?: Overrides): Promise<BigNumber>;
    ...
    ban(id_: BigNumberish, overrides?: Overrides): Promise<BigNumber>;
    ...
    states(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    ids(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
