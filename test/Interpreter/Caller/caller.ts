...
import { IInterpreterCallerConsumer, RainterpreterExpressionDeployer } from "../../../typechain";
import { InterpreterCallerMetaEvent, InterpreterCallerV1ConstructionConfigStruct } from "../../../typechain/contracts/flow/FlowCommon";
import { ExpressionAddressEvent, NewExpressionEvent } from "../../../typechain/contracts/interpreter/shared/RainterpreterExpressionDeployer";
import { areEqualExpressionConfigs, assertError, getEventArgs, getRainContractMetaBytes } from "../../../utils";
...
describe("Caller Test", async function () {
  ...
  it("should ensure caller is deployed with correct data for InterpreterCallerMeta event ", async function () { 
    ...
    const caller = (await callerFactory.deploy(metaHash_,interpreterCallerConfig)) as IInterpreterCallerConsumer;   
