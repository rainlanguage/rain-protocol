...
describe("BPoolFeeEscrow", async function () {
  describe("should continue to work correctly for", async function () {
    describe("claimFees and refundFees in the case of emergency mode for Trust for an auction that", async function () {
