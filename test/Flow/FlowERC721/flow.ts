...
import { FlowIOStructOutput } from "../../../typechain/contracts/flow/erc721/FlowERC721";
...
describe("FlowERC721 flow tests", async function () {
  ...
  before(async () => {
    ...
    flowERC721Factory = (await flowFactoryFactory.deploy(
      integrity.address
  ...
  //     mintBurn,
  //     burnBurn,
  //     flowIOBurn.inputNative,
  //     flowIOBurn.outputNative,
  //   ];
